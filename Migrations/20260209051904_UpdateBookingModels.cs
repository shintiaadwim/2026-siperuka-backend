        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StatusBooking = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BookingHistories_BookingStatuses_NewStatus",
                        column: x => x.NewStatus,
                        principalTable: "BookingStatuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BookingHistories_BookingStatuses_OldStatus",
                        column: x => x.OldStatus,
                        principalTable: "BookingStatuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookingHistories_Users_ChangedBy",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingHistories_ChangedBy",
                table: "BookingHistories",
                column: "ChangedBy");

            migrationBuilder.CreateIndex(
                name: "IX_BookingHistories_NewStatus",
                table: "BookingHistories",
                column: "NewStatus");

            migrationBuilder.CreateIndex(
                name: "IX_BookingHistories_OldStatus",
                table: "BookingHistories",
                column: "OldStatus");
